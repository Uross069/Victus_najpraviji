...
import 'package:practice/signup3.dart';
    ...
    return Positioned(
              ...
              child : SizedBox(
                ...
                child: ClipRRect(
                  ...
                  child : const Image(
                  image: AssetImage('images/uvod2.jpg'),
                  )
                ) 
              )
            );
  ...
  Widget build(BuildContext context) {
    return Positioned( 
                ...
                child: OutlinedButton(
                  ...
                  onPressed: () {
                    Navigator.of(context).push(MaterialPageRoute(builder: (context) => const Signup3(),));
                  },
                )
              );
  }
...
class Description extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Positioned(
              ...
              child: const Text(
                'Uštedite vrijeme i izbjegnite čekanje za stolom, rezervišite svoj sto brzo i jednostavno ili naručite hranu sa našeg menija i pripremite se za ukusni obrok koji Vas čeka po dolasku u restoran ili na Vašoj kućnoj adresi.',
