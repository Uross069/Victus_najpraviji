...
import 'package:practice/signup2.dart';
    ...
    return Positioned(
              ...
              child : SizedBox(
                ...
                child: ClipRRect(
                  ...
                  child : const Image(
                  image: AssetImage('images/uvod.png'),
                  )
                )
              )
            );
...
class Description extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Positioned(
              ...
              child: const Text(
                'Kako biste u potpunosti uživali u gastronomskom iskustvu i ukusnoj hrani, aplikacija Vam pruža sve potrebne informacije. Istražite jelovnik, cijene, sastojke jela, vrijeme pripreme, nutritivnu vrijednost i mnoštvo drugih detalja.',
